 ...
 */
public class EventTimelineParametersAssert extends AbstractAssert<EventTimelineParametersAssert, StreamTimelineParameters> {
     ...
     */
    public EventTimelineParametersAssert(StreamTimelineParameters actual) {
     ...
     */
    public static EventTimelineParametersAssert assertThat(StreamTimelineParameters actual) {
    ...
    public EventTimelineParametersAssert hasEventId(String eventId) {
        ...
        // null safe check
        String actualEventId = actual.getStreamId();
