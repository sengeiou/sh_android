...
public class GetUserFollowersInteractorTest {
  ...
  private GetUserFollowersInteractor getUserFollowersInteractor;
  ...
  public void setUp() throws Exception {
    ...
    getUserFollowersInteractor =
        new GetUserFollowersInteractor(interactorHandler, postExecutionThread, remoteUserRepository,
            localUserRepository, sessionRepository);
  }

  @Test
  public void shouldGetFollowersFromRemote() throws Exception {
    getUserFollowersInteractor.obtainFollowers(ID_USER, PAGE, callback, errorCallback);

    verify(remoteUserRepository).getFollowers(ID_USER, PAGE, PAGE_SIZE);
  }
  ...
  public void shouldNotifyErrorWhenRemoteThrowsServerCommunicationException() throws Exception {
    when(remoteUserRepository.getFollowers(anyString(), anyInt(), anyInt())).thenThrow(
  ...
  public void shouldNotifyLoadedEmptyListWhenNoFollowing() throws Exception {
    when(remoteUserRepository.getFollowers(anyString(), anyInt(), anyInt())).thenReturn(
  ...
  public void shouldNotifyLoadedUsersWhenFollowingOtherUsers() throws Exception {
    when(remoteUserRepository.getFollowers(anyString(), anyInt(), anyInt())).thenReturn(users());
