...
/**
 * {@link com.shootr.mobile.domain.StreamTimelineParameters} specific assertions - Generated by CustomAssertionGenerator.
 */
public class StreamTimelineParametersAssert extends AbstractAssert<StreamTimelineParametersAssert, com.shootr.mobile.domain.StreamTimelineParameters> {

    /**
     * Creates a new <code>{@link StreamTimelineParametersAssert}</code> to make assertions on actual TimelineParameters.
     *
     * @param actual the TimelineParameters we want to make assertions on.
     */
    public StreamTimelineParametersAssert(com.shootr.mobile.domain.StreamTimelineParameters actual) {
     ...
     */
    public static StreamTimelineParametersAssert assertThat(com.shootr.mobile.domain.StreamTimelineParameters actual) {
