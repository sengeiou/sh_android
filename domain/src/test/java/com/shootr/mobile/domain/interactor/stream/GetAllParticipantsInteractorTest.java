...
public class GetAllParticipantsInteractorTest {
  ...
  @Test public void shouldCallbackUserFollowedAndNotFollowedInStreamWhenNotPaginating() {
    ...
    when(remoteUserRepository.getAllParticipants(ID_STREAM, MAX_JOIN_DATE)).thenReturn(
        allParticipantsInStream());

    interactor.obtainAllParticipants(ID_STREAM, MAX_JOIN_DATE, NOT_PAGINATING, callback,
        errorCallback);
  ...
  @Test public void shouldCallbackUserFollowedAndNotFollowedInStreamWhenPaginating() {
    ...
    interactor.obtainAllParticipants(ID_STREAM, MAX_JOIN_DATE, IS_PAGINATING, callback,
        errorCallback);
