...
/**
 * {@link com.shootr.mobile.domain.Timeline} specific assertions - Generated by CustomAssertionGenerator.
 */
public class TimelineAssert extends AbstractAssert<TimelineAssert, com.shootr.mobile.domain.Timeline> {
   ...
   */
  public TimelineAssert(com.shootr.mobile.domain.Timeline actual) {
   ...
   */
  public static TimelineAssert assertThat(com.shootr.mobile.domain.Timeline actual) {
   ...
   */
  public TimelineAssert hasShots(List<com.shootr.mobile.domain.Shot> shots) {
