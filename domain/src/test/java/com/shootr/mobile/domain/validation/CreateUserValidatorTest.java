...
public class CreateUserValidatorTest {
    ...
    @Test public void shouldReturnEmailInvalidFormatErrorIfEmailHasInvalidFormat() throws Exception {
        ...
        assertThat(errors).contains(new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_EMAIL_INVALID_FORMAT,
    ...
    @Test public void shouldReturnEmailNullErrorIfEmailIsNull() throws Exception {
        ...
        assertThat(errors).contains(new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_EMAIL_NULL,
          CreateUserValidator.FIELD_EMAIL));
    }
    ...
    @Test public void shouldNotReturnEmailInvalidErrorIfEmailContainsPlusSign() throws Exception {
        ...
        assertThat(errors).doesNotContain(new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_EMAIL_INVALID_FORMAT,
          CreateUserValidator.FIELD_EMAIL));
    }
    ...
    private FieldValidationError usernameHasInvalidCharactersError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_USERNAME_INVALID_CHARACTERS,
          CreateUserValidator.FIELD_USERNAME);
    }

    private FieldValidationError passwordHasInvalidCharactersError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_PASSWORD_INVALID_CHARACTERS,
          CreateUserValidator.FIELD_PASSWORD);
    }

    private FieldValidationError passwordIsEqualToUsernameError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_PASSWORD_EQUALS_USERNAME,
          CreateUserValidator.FIELD_PASSWORD);
    }

    private FieldValidationError passwordTooShortError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_PASSWORD_TOO_SHORT,
          CreateUserValidator.FIELD_PASSWORD);
    }

    private FieldValidationError passwordTooLongError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_PASSWORD_TOO_LONG,
          CreateUserValidator.FIELD_PASSWORD);
    }

    private FieldValidationError passwordIsNullError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_PASSWORD_NULL,
          CreateUserValidator.FIELD_PASSWORD);
    }

    private FieldValidationError usernameTooLongError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_USERNAME_TOO_LONG,
          CreateUserValidator.FIELD_USERNAME);
    }

    private FieldValidationError usernameIsNullError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_USERNAME_NULL,
          CreateUserValidator.FIELD_USERNAME);
    }

    private FieldValidationError usernameTooShortError() {
        return new FieldValidationError(com.shootr.mobile.domain.exception.ShootrError.ERROR_CODE_REGISTRATION_USERNAME_TOO_SHORT,
          CreateUserValidator.FIELD_USERNAME);
    }
    //endregion
}