...
/**
 * {@link com.shootr.mobile.domain.QueuedShot} specific assertions - Generated by CustomAssertionGenerator.
 */
public class QueuedShotAssert extends AbstractAssert<QueuedShotAssert, com.shootr.mobile.domain.QueuedShot> {
   ...
   */
  public QueuedShotAssert(com.shootr.mobile.domain.QueuedShot actual) {
   ...
   * With a static import, one can write directly: <code>assertThat(myQueuedShot)</code> and get specific assertion with code completion.
   * @param actual the QueuedShot we want to make assertions on.
   * @return a new <code>{@link QueuedShotAssert}</code>
   */
  public static QueuedShotAssert assertThat(com.shootr.mobile.domain.QueuedShot actual) {
   ...
   */
  public QueuedShotAssert hasShot(com.shootr.mobile.domain.Shot shot) {
    // check that actual QueuedShot we want to make assertions on is not null.
    isNotNull();
    ...
    // null safe check
    com.shootr.mobile.domain.Shot actualShot = actual.getShot();
