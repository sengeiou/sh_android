...
public class ChangeCheckinSettingsInteractor implements Interactor {
  ...
  @Inject public ChangeCheckinSettingsInteractor(InteractorHandler interactorHandler,
  ...
  public void changeCheckinSettings(UserSettings userSettings, CompletedCallback callback,
  ...
  @Override public void execute() throws Exception {
    try {
      externalUserSettingsRepository.modifyCheckinSettings(userSettings);
      notifyResult();
