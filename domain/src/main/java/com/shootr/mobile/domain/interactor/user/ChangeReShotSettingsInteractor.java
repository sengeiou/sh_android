...
public class ChangeReShotSettingsInteractor implements Interactor {
  ...
  @Inject public ChangeReShotSettingsInteractor(InteractorHandler interactorHandler,
  ...
  public void changeReShotSettings(UserSettings userSettings, CompletedCallback callback,
  ...
  @Override public void execute() throws Exception {
    try {
      externalUserSettingsRepository.modifyReShotSettings(userSettings);
      notifyResult();
