...
public class ManageContributorsInteractor implements Interactor {
  ...
  @Inject public ManageContributorsInteractor(InteractorHandler interactorHandler,
  ...
  public void manageContributor(String idStream, String idUser, Boolean isAdding,
