...
public class GetOlderStreamTimelineInteractor implements com.shootr.mobile.domain.interactor.Interactor {
    ...
    @Inject public GetOlderStreamTimelineInteractor(
    ...
    public void loadOlderStreamTimeline(Long currentOldestDate, Callback<com.shootr.mobile.domain.Timeline> callback,
    ...
    @Override public void execute() throws Exception {
        try {
            ...
            List<com.shootr.mobile.domain.Shot> olderShots = remoteShotRepository.getShotsForStreamTimeline(timelineParameters);
