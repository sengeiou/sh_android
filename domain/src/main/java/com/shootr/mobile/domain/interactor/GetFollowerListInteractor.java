...
public class GetFollowerListInteractor implements Interactor {
  ...
  @Inject public GetFollowerListInteractor(InteractorHandler interactorHandler,
  ...
  @Override public void execute() throws Exception {
    try {
      Follows following =
          followRepository.getFollowers(idUser, FollowableType.FOLLOWABLE_TYPES, maxTimestamp);
