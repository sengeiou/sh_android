...
public class ProfileEditPresenterTest {
  ...
  @Before public void setUp() throws Exception {
    ...
    presenter = new ProfileEditPresenter(sessionRepository, userModelMapper, errorMessageFactory,
        getUserByIdInteractor, updateUserProfileInteractor);
  }
  ...
  @Test public void shouldNotShowUpdatedSuccessfulAlertWhenUserNameAndWebIsEmpty()
      throws Exception {
    setupUpdateUserProfileInteractor();
    setUpGetUserByIdInteractor();
    when(sessionRepository.getCurrentUser()).thenReturn(facebookUser());
  ...
  private void setupUpdateUserProfileInteractor() {
    doAnswer(new Answer() {
      @Override public Object answer(InvocationOnMock invocation) throws Throwable {
        ...
        .updateProfile(any(User.class), any(Interactor.CompletedCallback.class),
  ...
  private void setUpGetUserByIdInteractor() {
    doAnswer(new Answer() {
      @Override public Object answer(InvocationOnMock invocation) throws Throwable {
        ((GetUserByIdInteractor.Callback) invocation.getArguments()[2]).onLoaded(facebookUser());
        return null;
      }
