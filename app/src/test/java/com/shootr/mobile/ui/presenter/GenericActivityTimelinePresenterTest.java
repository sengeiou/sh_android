...
public class GenericActivityTimelinePresenterTest {
  ...
  @Before public void setUp() throws Exception {
    ...
    genericActivityTimelinePresenter =
        new GenericActivityTimelinePresenter(activityTimelineInteractorWrapper, activityModelMapper,
            followStreamInteractor, unfollowStreamInteractor, bus, errorMessageFactory, poller,
            badgeCount, sessionRepository);
    genericActivityTimelinePresenter.setView(view);
  }

  @Test
  public void shouldSetActivitiesInViewWhenInitializeAllActivitiesAndTimelineNotEmptyCallback()
      throws Exception {
  ...
  @Test public void shouldHideEmptyWhenInitializeAllActivitiesAndTimelineNotEmptyCallback()
      throws Exception {
    setupLoadTimelineCallback();
  ...
  @Test public void shouldShowActivitiesWhenInitializeAllActivitiesAndTimelineNotEmptyCallback()
      throws Exception {
    setupLoadTimelineCallback();
  ...
  @Test public void shouldShowEmptyWhenInitializeAllActivitiesAndTimelineEmptyCallback()
      throws Exception {
  ...
  @Test public void shouldHideActivitiesWhenInitializeAllActivitiesAndTimelineEmptyCallback()
      throws Exception {
    setupLoadEmptyTimelineCallback();
  ...
  @Test public void shouldHideLoadingActivitiyWhenRefreshAndRefreshTimelineCallback()
      throws Exception {
    setupRefreshTimelineCallback();
  ...
  @Test public void shouldHideLoadingOldActivitiesWhenObtainOlderActivitiesTimelineCallback()
      throws Exception {
  ...
  @Test public void shouldAddOldActivitiesWhenObtainOlderActivitiesTimelineCallback()
      throws Exception {
    setupOlderTimelineCallback();
  ...
  private void setupOlderTimelineCallback() {
    doAnswer(new Answer() {
      @Override public Object answer(InvocationOnMock invocation) throws Throwable {
        ...
        .obtainOlderTimeline(anyBoolean(), anyLong(), any(Interactor.Callback.class),
  ...
  private void setupRefreshTimelineCallback() {
    doAnswer(new Answer() {
      @Override public Object answer(InvocationOnMock invocation) throws Throwable {
        ...
        .refreshTimeline(anyBoolean(), any(Interactor.Callback.class),
            any(Interactor.ErrorCallback.class));
  }
  ...
  private void setupLoadTimelineCallback() {
    doAnswer(new Answer() {
      @Override public Object answer(InvocationOnMock invocation) throws Throwable {
        ...
        .loadTimeline(anyBoolean(), any(Interactor.Callback.class));
  }
