...
public class GetFollowingsJob extends CancellableJob{
    ...
    public void onRun() throws Throwable {
        ...
        try {
            ...
            List<Follow> followings = service.getFollows(currentUser.getIdUser(), modifiedFollows, UserDtoFactory.GET_FOLLOWING);
            if(followings == null) {
...
//            Long modifiedUsers = SyncTableManager.getLastModifiedDate(mDbHelper.getReadableDatabase(), GMContract.UserTable.TABLE);
            List<User> usersFollowing = service.getUsersByUserIdList(followingIds);
