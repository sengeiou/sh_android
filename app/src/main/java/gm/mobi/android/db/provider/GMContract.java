...
public class GMContract {
    ...
    * */
    ...
    /*AppAdvice table constants*/
    public static final class AppAdviceTable implements AppAdviceColumns, SyncColumns{
        /*ContentUri for this table*/
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_APPADVICE).build();
        /*MIME type of a directory items*/
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/vnd.gm.appAdvice";
        /*MIME type single item*/
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE+"/vnd.gm.appAdvice";
        /* Read {@link #ID_APPADVICE} from {@link AppAdviceTable}{@link URI}**/
        public static String getAppAdviceId(Uri uri){
            return uri.getPathSegments().get(1);
        }
        /* Read {@link #ID_MESSAGE} from {@link AppAdviceTable}{@link URI}**/
        public static String getMessageId(Uri uri){
            return uri.getPathSegments().get(2);
        }
        /*Build {@link Uri} for requested {@link #idAppAdvice, # idMessage}*/
        public static Uri buildAppAdviceUri(String idAppAdvice, String idMessage){
            return CONTENT_URI.buildUpon().appendPath(idAppAdvice).appendPath(idMessage).build();
        }
    ...
    /*BetType table constants*/
    public static final class BetTypeTable implements BetTypeColumns, SyncColumns{
        /* Content Uri for this table**/
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_BETTYPE).build();
        /* MIME type of a directory of items*/
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/vnd.gm.bettype";
        /* MIME type of a single item*/
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE+"/vnd.gm.bettype";
        /* Read {@link #BETTYPE_ID} from {@link BETTYPE_TABLE}*/
        public static String getBetTypeId(Uri uri){
            return uri.getPathSegments().get(1);
        }
        /*Build {@link Uri} for requested {@link BETTYPE_ID}*/
        public static Uri buildBetTypeUri(String betTypeId){
            return CONTENT_URI.buildUpon().appendPath(betTypeId).build();
        }
        /*Projection all column items in the table*/
        public static final String[] PROJECTION = {
                ID_BETTYPE,
                UNIQUE_KEY,
                NAME,
    ...
    /*BetTypeOdd table constants*/
    public static final class BetTypeOddTable implements BetTypeOddColumns, SyncColumns{
        /*Content Uri for this table*/
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_BETTYPEODD).build();
        /*MIME type for directory items*/
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE+"/vnd.gm.bettypeodd";
        /*MIME type for single item*/
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE+"/vnd.gm.bettypeodd";
        /*Read {@link #BETTYPEODD_ID} from {@link BetTypeOddTable}{@link Uri}*/
        public static String getBetTypeOddId(Uri uri){
            return uri.getPathSegments().get(1);
        }
        /*Read {@link #MATCHBETTYPE_ID} from {@link BetTypeOddTable}{@link Uri}*/
        public static String getMatchBetTypeId(Uri uri){
            return uri.getPathSegments().get(1);
        }
        /*Build {@link Uri} for requested {@link #BETTYPEODD_ID, #MATCHBETTYPE_ID}*/
        public static Uri buildBetTypeOddUri(String betTypeOddId, String matchBetTypeId){
            return CONTENT_URI.buildUpon().appendPath(betTypeOddId).appendPath(matchBetTypeId).build();
        }
        /*Projection of column items table*/
           public static final String[] PROJECTION = {
                ID_BETTYPEODD,
                ID_MATCHBETTYPE,
                NAME,
    ...
    /*Classification table constants*/
    public static final class ClassificationTable implements ClassificationColumns, SyncColumns {
        /*Content Uri for this table*/
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_CLASSIFICATION).build();
        /*MIME type for directory items*/
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.gm.classification";
        /*MIME type for single item*/
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.gm.classification";

        /*Read {@link #TEAM_ID} from {@link TeamTable}{@link Uri}*/
        public static String getTeamId(Uri uri) {
            return uri.getPathSegments().get(1);
        }

        /*Read {@link #TOURNAMENT_ID} from {@link TournamentTable}{@link Uri}*/
        public static String getTournamentId(Uri uri) {
            return uri.getPathSegments().get(1);
        }

        /*Build {@link Uri} for requested {@link #TEAM_ID, #TOURNAMENT_ID}*/
        public static Uri buildBetTypeOddUri(String teamId, String tournamentId) {
            return CONTENT_URI.buildUpon().appendPath(teamId).appendPath(tournamentId).build();
        }
