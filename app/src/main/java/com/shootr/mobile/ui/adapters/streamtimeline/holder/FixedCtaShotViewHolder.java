...
public class FixedCtaShotViewHolder extends CtaShotViewHolder {
  ...
  public FixedCtaShotViewHolder(View itemView, OnAvatarClickListener avatarClickListener,
  ...
  public void render(final ShotModel shotModel, final ShotClickListener shotClickListener,
      ...
      OnOpenShotMenuListener onOpenShotMenuListener, final OnCtaClickListener onCtaClickListener, Boolean isAdmin) {
  ...
  private void setupListeners(final ShotModel shotModel,
    ...
    hideHighlighted.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View view) {
        //TODO onHideHighlightClickListener.onHideClick(shotModel);
      }
    });
