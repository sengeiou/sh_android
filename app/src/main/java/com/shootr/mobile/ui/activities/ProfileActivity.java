...
public class ProfileActivity extends BaseActivity
    ...
    @Override protected void initializeViews(Bundle savedInstanceState) {
        ...
        latestsShotsAdapter = new TimelineAdapter(this,
            imageLoader,
            timeUtils,
            avatarClickListener,
            videoClickListener,
    ...
    @Override public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == REQUEST_CHOOSE_PHOTO) {
                ...
                try {
                    changedPhotoFile = new File(
                        FileChooserUtils.getPath(this, selectedImageUri));
    ...
    @Override public void showLogoutInProgress() {
        if (this != null) {
            progress =
                ProgressDialog.show(this, null, this.getString(R.string.sign_out_message), true);
        }
    }
