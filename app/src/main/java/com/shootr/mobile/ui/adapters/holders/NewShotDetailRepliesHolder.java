...
public class NewShotDetailRepliesHolder extends BaseViewHolder<ShotModel> {
    ...
    public NewShotDetailRepliesHolder(View itemView, ShotTextSpannableBuilder shotTextSpannableBuilder,
