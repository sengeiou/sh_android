...
public class ResetPasswordActivity extends BaseToolbarDecoratedActivity {
  ...
  private void transitionToConfirmationView(ForgotPasswordUserModel forgotPasswordUserModel) {
    ...
    resetPasswordConfirmationPresenter.initialize(resetPasswordConfirmationView,
  ...
  public class InnerResetPasswordRequestView implements ResetPasswordRequestView {
    ...
    @Override public void navigateToResetPasswordConfirmation(
    ...
    @Override public void hideKeyboard() {
      InputMethodManager imm = (InputMethodManager) ResetPasswordActivity.this.getSystemService(
  ...
  public class InnerResetPasswordConfirmationView implements ResetPasswordConfirmationView {
    ...
    @Override public void showPostConfirmationMessage(String email) {
      ...
      confirmationMessage.setText(
          getString(R.string.reset_password_confirmation_message_email_pattern, email));
    }
