 ...
 */
public abstract class SubheaderRecyclerViewAdapter<VH extends RecyclerView.ViewHolder, H, T>
    extends RecyclerView.Adapter<VH> {

  protected static final int TYPE_HEADER = -2;
  protected static final int TYPE_SUBHEADER = -3;
  ...
  protected boolean isSubheaderType(int viewType) {
    return viewType == TYPE_SUBHEADER;
  }
