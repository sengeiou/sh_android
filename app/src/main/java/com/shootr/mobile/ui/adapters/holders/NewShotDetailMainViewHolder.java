...
public class NewShotDetailMainViewHolder extends BaseViewHolder<ShotModel> {
  ...
  public NewShotDetailMainViewHolder(View itemView, ImageLoader imageLoader,
  ...
  private void setupShareListener(ShotModel shotModel) {
    if (shotModel.isReshooted()) {
      ...
      reshootText.setTextColor(reshootText.getResources().getColor(R.color.actions));
    } else {
