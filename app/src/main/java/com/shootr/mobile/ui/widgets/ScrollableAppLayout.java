...
public class ScrollableAppLayout extends AppBarLayout {
  ...
  public ScrollableAppLayout(Context context) {
    super(context);
  }

  public ScrollableAppLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  @Override protected void onAttachedToWindow() {
    ...
    if (!(getLayoutParams() instanceof CoordinatorLayout.LayoutParams)
      ...
      throw new IllegalStateException(
          "ScrollableAppBar must be a direct child of CoordinatorLayout.");
    } else {
  ...
  private void performCollapsingWithoutAnimation() {
    if (mParent.get() != null) {
      mBehavior.onNestedPreScroll(mParent.get(), this, null, 0, getHeight() / 4,
          new int[] { 0, 0 });
    }
  }
