...
public class DatabaseContract {
  ...
  public static class StreamTable implements SyncColumns {
    ...
    public static final String[] PROJECTION = {
        ...
        FOLLOWING, VIEWS, MUTED, LAST_TIME_SHOOTED, REMOVED, DELETED, REVISION, SYNCHRONIZED
    };
  }
  ...
  public static class StreamSearchTable extends StreamTable {
    ...
    public static final String[] PROJECTION = {
        ...
        I_AM_CONTRIBUTOR, TOTAL_FOLLOWING_WATCHERS, STRATEGIC, MUTED, LAST_TIME_SHOOTED, FOLLOWING,
        VIEWS, BIRTH, MODIFIED, DELETED, REVISION, SYNCHRONIZED
    };
  }
