...
public class DatabaseContract {
  ...
  public static class UserTable implements SyncColumns {
    ...
    public static final String[] PROJECTION = {
        ...
        FAVORITED_STREAMS_COUNT, SOCIAL_LOGIN, RECEIVED_REACTIONS, ANALYTICS_USER_TYPE, BIRTH,
  ...
  public static class ShotTable implements SyncColumns {
    ...
    public static final String[] PROJECTION = {
        ...
        RESHOOT_COUNT, CTA_CAPTION, CTA_BUTTON_LINK, CTA_BUTTON_TEXT, PROMOTED, VERIFIED_USER, IS_PADDING,
  ...
  public static class StreamTable implements SyncColumns {
    ...
    public static final String[] PROJECTION = {
        ...
        VERIFIED_USER, REMOVED, DELETED, REVISION, SYNCHRONIZED
    };
  }
  ...
  public static class StreamSearchTable extends StreamTable {
    ...
    public static final String[] PROJECTION = {
        ...
        TOTAL_SHOTS, UNIQUE_SHOTS, READ_WRITE_MODE, VERIFIED_USER, BIRTH, MODIFIED, DELETED,
  ...
  public static final class HighlightedShotTable extends ShotTable {
    ...
    public static final String[] PROJECTION = {
        ...
        CTA_BUTTON_TEXT, PROMOTED, VERIFIED_USER, IS_PADDING, BIRTH, MODIFIED, DELETED, REVISION, SYNCHRONIZED
    };
  }
