...
public class DatabaseContract {
    ...
    public static class StreamTable implements SyncColumns {
        ...
        public static final String[] PROJECTION = {
          ID_STREAM, ID_USER, ID_USER_STREAM, USERNAME, TITLE, MEDIA_COUNT,
                PHOTO, SHORT_TITLE, DESCRIPTION, BIRTH, MODIFIED, LAST_UPDATED_USER, COUNTRY, TOTAL_FAVORITES, TOTAL_WATCHERS, HISTORIC_WATCHERS, REMOVED, DELETED, REVISION, SYNCHRONIZED
        };
    }
    ...
    public static class StreamSearchTable extends StreamTable {
        ...
        public static final String[] PROJECTION = {
          WATCHERS, COUNTRY, ID_STREAM, ID_USER, USERNAME, TITLE, PHOTO, SHORT_TITLE, DESCRIPTION, REMOVED, MEDIA_COUNT, TOTAL_FAVORITES, TOTAL_WATCHERS, HISTORIC_WATCHERS, BIRTH, MODIFIED, DELETED, REVISION, SYNCHRONIZED
        };
