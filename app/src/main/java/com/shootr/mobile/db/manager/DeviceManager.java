...
public class DeviceManager extends AbstractManager {
    ...
    @Inject public DeviceManager(SQLiteOpenHelper openHelper, DeviceEntityDBMapper deviceMapper) {
        super(openHelper);
        this.deviceMapper = deviceMapper;
    }

    public DeviceEntity getDevice() {
        Cursor queryResult = getReadableDatabase().query(DatabaseContract.DeviceTable.TABLE,
          DatabaseContract.DeviceTable.PROJECTION,
          null,
          null,
          null,
          null,
