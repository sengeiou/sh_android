...
public class HighlightedShotEntityDBMapper extends GenericDBMapper {
  ...
  public HighlightedShotEntity fromCursor(Cursor c) {
    ...
    highlightedShot.setPadding(
        (c.getLong(c.getColumnIndex(DatabaseContract.HighlightedShotTable.IS_PADDING)) == 1L));
  ...
  public ContentValues toContentValues(HighlightedShotEntity highlightedShot) {
    ...
    contentValues.put(DatabaseContract.HighlightedShotTable.USERNAME, highlightedShot.getUsername());
    contentValues.put(DatabaseContract.HighlightedShotTable.USER_PHOTO, highlightedShot.getUserPhoto());
    ...
    contentValues.put(DatabaseContract.HighlightedShotTable.IMAGE_WIDTH, highlightedShot.getImageWidth());
    contentValues.put(DatabaseContract.HighlightedShotTable.IMAGE_HEIGHT, highlightedShot.getImageHeight());
    contentValues.put(DatabaseContract.HighlightedShotTable.STREAM_TITLE, highlightedShot.getStreamTitle());
    contentValues.put(DatabaseContract.HighlightedShotTable.ID_STREAM, highlightedShot.getIdStream());
    contentValues.put(DatabaseContract.HighlightedShotTable.TYPE, highlightedShot.getType());
    contentValues.put(DatabaseContract.HighlightedShotTable.NICE_COUNT, highlightedShot.getNiceCount());
    contentValues.put(DatabaseContract.HighlightedShotTable.ID_SHOT_PARENT, highlightedShot.getIdShotParent());
    contentValues.put(DatabaseContract.HighlightedShotTable.ID_USER_PARENT, highlightedShot.getIdUserParent());
    contentValues.put(DatabaseContract.HighlightedShotTable.USERNAME_PARENT, highlightedShot.getUserNameParent());
    contentValues.put(DatabaseContract.HighlightedShotTable.VIDEO_URL, highlightedShot.getVideoUrl());
    contentValues.put(DatabaseContract.HighlightedShotTable.VIDEO_TITLE, highlightedShot.getVideoTitle());
    contentValues.put(DatabaseContract.HighlightedShotTable.VIDEO_DURATION, highlightedShot.getVideoDuration());
    contentValues.put(DatabaseContract.HighlightedShotTable.PROFILE_HIDDEN, highlightedShot.getProfileHidden());
    ...
    contentValues.put(DatabaseContract.HighlightedShotTable.IS_PADDING, highlightedShot.isPadding() ? 1L : 0L);
