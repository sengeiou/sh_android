...
@Module(
  ...
  complete = false,
  library = true) public class WatchersRepositoryModule {

    @Provides @Local WatchersRepository provideLocalWatchersRepository(LocalWatchersRepository watchersRepository) {
