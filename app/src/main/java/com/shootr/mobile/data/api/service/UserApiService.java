...
public interface UserApiService {
  ...
  @GET("/user/{idUser}") UserEntity getUser(@Path("idUser") String idUser)
      throws IOException, ApiException;

  @GET("/user?includeLinks=false&includeEmbed=false") UserEntity getUser()
      throws IOException, ApiException;
  ...
  @GET("/user/streamParticipants/{idStream}/search") List<UserEntity> findParticipants(
      @Path("idStream") String idStream, @Query("query") String query)
      throws IOException, ApiException;
  ...
  @PUT("/user/") UserEntity putUser(@Body UserApiEntity userApiEntity)
      throws IOException, ApiException;

  @GET("/user/suggested") List<SuggestedPeopleEntity> getSuggestedPeople(
      @Query("locale") String locale) throws IOException, ApiException;
  ...
  @DELETE("/block/{idUser}") Response unblock(@Path("idUser") String idUser)
      throws IOException, ApiException;
  ...
  @POST("/user/{idUser}/mute") Response mute(@Path("idUser") String idUser)
      throws IOException, ApiException;
