...
public interface ResetPasswordApiService {
    ...
    @POST("/auth/forgotPassword") ForgotPasswordResultEntity passwordReset(
      @Body ForgotPasswordEntity forgotPasswordEntity) throws ApiException, IOException;

    @POST("/auth/resetPassword") Response sendResetPasswordEmail(@Body ResetPasswordEntity resetPasswordEntity)
