...
public interface AuthApiService {
    ...
    @POST("/auth/socialAuthenticate/facebook") FacebookUserEntity authenticateWithFacebook(@Body
    FacebookLoginApiEntity facebookLoginApiEntity) throws ApiException, IOException;
    ...
    @POST("/auth/logout")
    Void logout(@Body LogoutApiEntity logoutEntity) throws ApiException, IOException;
}
