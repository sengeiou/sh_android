    ...
    IntentFactory REAL = new IntentFactory() {
        ...
        @Override public Intent openEmbededUrlIntent(Activity launchActivity, String url) {
            CustomTabsIntent customTabIntent =
              new CustomTabsIntent.Builder().setToolbarColor(launchActivity.getResources().getColor(R.color.primary))
                .setShowTitle(true)
                .build();
        ...
        @Override
        public Intent reportEmailIntent(Activity launchActivity, String currentUserId, String reportedUserId) {
