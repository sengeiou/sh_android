...
public class DatabaseContract {
    ...
    public static final class UserTable implements SyncColumns {
        ...
        public static final String[] PROJECTION = {
          ...
          NUM_FOLLOWINGS, POINTS, WEBSITE, BIO, RANK, CHECK_IN, EVENT_ID, EVENT_TITLE,
    ...
    public static class EventSearchTable extends EventTable {
        ...
        public static final String[] PROJECTION = {
          WATCHERS,
          ID_EVENT, ID_USER, USERNAME, BEGIN_DATE, END_DATE, TIMEZONE, TITLE, PHOTO, TAG, CSYS_BIRTH, CSYS_MODIFIED,
          CSYS_DELETED, CSYS_REVISION, CSYS_SYNCHRONIZED
        };
