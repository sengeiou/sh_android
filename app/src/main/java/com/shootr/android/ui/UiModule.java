...
@Module(
  injects = {
    ...
    FindFriendsActivity.class, EventDetailActivity.class, ProfileEditActivity.class, ShotDetailActivity.class,
    PhotoViewActivity.class, EventTimelineActivity.class, PeopleFragment.class, WatchersView.class,
    NewEventActivity.class, EventMediaActivity.class, UpdateWarningActivity.class, DraftsActivity.class,
    DraftsPresenter.class, MainTabbedActivity.class, ResetPasswordActivity.class, ListingActivity.class,
    FavoritesFragment.class, ActivityTimelineContainerActivity.class, ActivityTimelineFragment.class,
    EventTimelineFragment.class, FindEventsActivity.class, WhaleActivity.class,
  },
