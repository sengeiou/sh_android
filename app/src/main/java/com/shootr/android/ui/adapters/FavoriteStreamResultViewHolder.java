...
public class FavoriteStreamResultViewHolder extends RecyclerView.ViewHolder {
    ...
    public FavoriteStreamResultViewHolder(View itemView, OnStreamClickListener onStreamClickListener, PicassoWrapper picasso) {
        super(itemView);
