...
@Module(
  ...
  overrides = true) public class DebugApiModule {
    ...
    @Provides AuthApiService provideAuthApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
    ...
    @Provides StreamApiService provideStreamApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(StreamApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides UserApiService provideUserApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(UserApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides ShotApiService provideShotApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(ShotApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides VideoApiService provideVideoApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(VideoApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides FavoriteApiService provideFavoriteApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(FavoriteApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides ActivityApiService provideActivityApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
    ...
    @Provides DeviceApiService provideDeviceApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      @DebugMode BooleanPreference debugMode) {
        return mockOrRealService(DeviceApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    private <T> T mockOrRealService(Class<T> serviceClass, RestAdapter restAdapter, MockRestAdapter mockRestAdapter,
      boolean isDebug) {
