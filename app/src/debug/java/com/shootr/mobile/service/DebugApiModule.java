...
public class DebugApiModule {
    ...
    @Provides AuthApiService provideAuthApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter, @DebugMode
    BooleanPreference debugMode) {
        return mockOrRealService(AuthApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides ResetPasswordApiService provideResetPasswordApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter, @DebugMode
    BooleanPreference debugMode) {
    ...
    @Provides VideoApiService provideVideoApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter, @DebugMode
    BooleanPreference debugMode) {
      return mockOrRealService(VideoApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides FavoriteApiService provideFavoriteApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter, @DebugMode
    BooleanPreference debugMode) {
      return mockOrRealService(FavoriteApiService.class, restAdapter, mockRestAdapter, debugMode.get());
    }

    @Provides ActivityApiService provideActivityApiService(RestAdapter restAdapter, MockRestAdapter mockRestAdapter, @DebugMode
    BooleanPreference debugMode) {
