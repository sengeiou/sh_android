...
@property (nonatomic, readonly, strong) SyncControlID* objectID;
...
@property (atomic) int64_t lastCallValue;
...
@property (atomic) int64_t lastServerDateValue;
...
@property (atomic) int64_t updatePriorityValue;
