 ...
 */
function initCacheMonitorMonitor(maxBytesLocalHeap, maxBytesLocalDisk,
 ...
 */
function cacheMonitorRequestWindow(cacheMonitorWindow, isRefresh) {
...
function startCacheMonitor(cacheMonitorWindow) {
	...
	App.cacheMonitorInterval = setInterval(function() {
		...
		cacheMonitorRequestWindow(cacheMonitorWindow, true);
