...
namespace Bagdad.Utils
{
    class SQLQuerys
    {
        ...
        public const String UpdateUnFollowSynchro = "UPDATE Follow set csys_synchronized = 'S' WHERE csys_synchronized = 'D' AND idUser = @idUser AND idUserFollowed = @idUserFollowed";
