package com.fav24.dataservices.to.exception;
 ...
 * @author Fav24
 */
public class ExceptionTO extends ResultBaseTO {
	 ...
	 */
	public ExceptionTO(String errorCode, String message) {
	 ...
	 */
	public ExceptionTO(String errorCode, String message, String exceptionMessage) {
