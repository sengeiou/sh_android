...
public class TeamDAOImpl  extends BaseDAOImpl implements TeamDAO {
    ...
    public List<Team> getAllTeams(){
        ...
        List<Team> list = getJdbcTemplate().query(query, new Object[]{}, new BeanPropertyRowMapper<Team>(Team.class));
        return list;
    }
    ...
    public Long insertTeam(Team team){
        ...
        Object[] params = new Object[]{
              team.getClubName(),team.getOfficialName(),team.getShortName(),team.getTlaName()
