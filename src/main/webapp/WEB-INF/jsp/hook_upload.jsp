...
<form:form id="uploadForm" class="form-inline" method="post" modelAttribute="uploadHookFiles" enctype="multipart/form-data">
<div class="panel panel-default">
	<div class="panel-heading">Carga de puntos de inserci&oacute;n (hooks)</div>
	<div class="panel-body">
		<p>Selecciona los fuentes de los hooks a cargar.</p>
		<!-- List group -->
...
<div>
	<button id="uploadButton" type="button" class="center-block btn btn-warning btn-lg">Cargar ficheros de hooks</button>
</div>
</form:form>
