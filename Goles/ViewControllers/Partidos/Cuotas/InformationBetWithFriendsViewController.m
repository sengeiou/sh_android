//
//  InformationBetWithFriendsViewController.m
//  Goles Messenger
//
...
@interface InformationBetWithFriendsViewController ()

@end

@implementation InformationBetWithFriendsViewController
...
- (void)createInformationView {
    ...
    NSString *linkText = [NSString stringWithFormat:@"Registrarse en %@ con Goles Messenger", self.mProvider.name];
    
    UIView *firstView = [Utils createTableHeaderView:NSLocalizedString(@"_secondTextInView", nil)
                                       withFirstLink:linkText
